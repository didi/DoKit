...
- (void)viewDidLoad {
    ...
    UIScrollView *scrollView = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, self.view.height-tabBarHeight-navBarHeight)];
    scrollView.contentSize = CGSizeMake(self.view.width, 20+160+20+260+20+260);
    [self.view addSubview:scrollView];
    
    _totalView = [[DoraemonNetFlowSummaryTotalDataView alloc] initWithFrame:CGRectMake(10, 20, self.view.width-20, 160)];
    [scrollView addSubview:_totalView];
    
    _methodView = [[DoraemonNetFlowSummaryMethodDataView alloc] initWithFrame:CGRectMake(10, _totalView.bottom+20, self.view.width-20, 260)];
    [scrollView addSubview:_methodView];
    
    _typeView = [[DoraemonNetFlowSummaryTypeDataView alloc] initWithFrame:CGRectMake(10, _methodView.bottom+20, self.view.width-20, 260)];
