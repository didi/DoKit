 ...
 */
class AnalyzedHeap(val heapDump: HeapDump, val result: AnalysisResult,
                   val selfFile: File) {
    @JvmField
    ...
    companion object {
        @JvmStatic
        fun save(heapDump: HeapDump, result: AnalysisResult): File? {
            val analyzedHeapfile = File(heapDump.heapDumpFile.parentFile,
