...
open class UniversalActivity : BaseActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (index) {
            ...
            FragmentIndex.FRAGMENT_FRAME_INFO -> fragmentClass = DokitManagerFragment::class.java
            FragmentIndex.FRAGMENT_CPU -> fragmentClass = CpuInfoPageFragment::class.java
            FragmentIndex.FRAGMENT_RAM -> fragmentClass = DokitManagerFragment::class.java
            else -> {
            }
        }
