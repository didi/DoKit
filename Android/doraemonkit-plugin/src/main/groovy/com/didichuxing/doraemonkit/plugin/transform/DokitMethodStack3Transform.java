 ...
 * ================================================
 */
public class DokitMethodStack3Transform extends HunterTransform {

    private DoKitExt dokitExtension;
    private String extensionName = "dokitExt";
    private AppExtension appExtension;

    public DokitMethodStack3Transform(Project project) {
        super(project);
        try {
            ...
            this.bytecodeWeaver = new DokitMethodStackWeaver(appExtension, MethodStackNodeUtil.LEVEL_3);
