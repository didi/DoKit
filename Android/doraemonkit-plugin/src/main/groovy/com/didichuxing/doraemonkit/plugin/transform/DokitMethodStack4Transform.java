 ...
 * ================================================
 */
public class DokitMethodStack4Transform extends HunterTransform {

    private DokitExtension dokitExtension;
    private String extensionName = "dokitExt";
    private AppExtension appExtension;

    public DokitMethodStack4Transform(Project project) {
        super(project);
        try {
            ...
            this.bytecodeWeaver = new DokitMethodStackWeaver(appExtension, MethodStackNodeUtil.LEVEL_4);
