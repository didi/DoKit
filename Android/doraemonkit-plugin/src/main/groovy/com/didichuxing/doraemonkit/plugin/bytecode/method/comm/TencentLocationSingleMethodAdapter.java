 ...
 */
public final class TencentLocationSingleMethodAdapter extends LocalVariablesSorter implements Opcodes {

    public TencentLocationSingleMethodAdapter(int access, String desc, MethodVisitor mv) {
