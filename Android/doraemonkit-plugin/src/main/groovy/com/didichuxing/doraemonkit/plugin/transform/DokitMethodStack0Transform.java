 ...
 * ================================================
 */
public class DokitMethodStack0Transform extends HunterTransform {

    private DoKitExt dokitExtension;
    private String extensionName = "dokitExt";
    private AppExtension appExtension;

    public DokitMethodStack0Transform(Project project) {
        super(project);
        try {
            ...
            this.bytecodeWeaver = new DokitMethodStackWeaver(appExtension, MethodStackNodeUtil.LEVEL_0);
