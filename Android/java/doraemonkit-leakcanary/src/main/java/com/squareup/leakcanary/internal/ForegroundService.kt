...
abstract class ForegroundService(name: String?, private val notificationContentTitleResId: Int) : IntentService(name) {
    private val notificationId: Int = SystemClock.uptimeMillis().toInt()
    ...
    protected fun showForegroundNotification(max: Int, progress: Int, indeterminate: Boolean,
                                             contentText: String?) {
