...
open class UniversalActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        when (index) {
            ...
            FragmentIndex.FRAGMENT_THIRD_LIBRARY_INFO -> fragmentClass =
                ThirdLibInfoFragment::class.java
            FragmentIndex.FRAGMENT_FILE_EXPLORER -> fragmentClass = FileExplorerFragment::class.java
            FragmentIndex.FRAGMENT_LOG_INFO_SETTING -> fragmentClass =
                LogInfoSettingFragment::class.java
            FragmentIndex.FRAGMENT_COLOR_PICKER_SETTING -> fragmentClass =
                ColorPickerSettingFragment::class.java
            FragmentIndex.FRAGMENT_GPS_MOCK -> fragmentClass = GpsMockFragment::class.java
            FragmentIndex.FRAGMENT_ALIGN_RULER_SETTING -> fragmentClass =
                AlignRulerSettingFragment::class.java
            ...
            FragmentIndex.FRAGMENT_NETWORK_MONITOR -> fragmentClass =
                NetWorkMonitorFragment::class.java
            ...
            FragmentIndex.FRAGMENT_WEB_DOOR_DEFAULT -> fragmentClass =
                WebDoorDefaultFragment::class.java
            ...
            FragmentIndex.FRAGMENT_MOCK_TEMPLATE_PREVIEW -> fragmentClass =
                MockTemplatePreviewFragment::class.java
