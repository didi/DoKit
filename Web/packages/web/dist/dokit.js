(function (vue) {
  ...
  */
  ...
  const _hoisted_4$5 = { class: "item-list" };
  const _hoisted_5$4 = { class: "item-icon" };
  const _hoisted_6$3 = { class: "item-title" };
  vue.popScopeId();
      ...
      vue.createVNode("div", _hoisted_4$5, [
        (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($props.list, (item, index) => {
          return (vue.openBlock(), vue.createBlock("div", {
            ...
            vue.createVNode("div", _hoisted_6$3, vue.toDisplayString(item.nameZh || '默认功能'), 1 /* TEXT */)
          ], 8 /* PROPS */, ["onClick"]))
        }), 128 /* KEYED_FRAGMENT */))
      ])
    ]))
  ...
  const _hoisted_3$d = { class: "version-image" };
  vue.popScopeId();
  ...
  const _withId$a = /*#__PURE__*/vue.withScopeId("data-v-957c9522");

  vue.pushScopeId("data-v-957c9522");
  const _hoisted_1$j = { class: "index-container" };
  vue.popScopeId();

  const render$l = /*#__PURE__*/_withId$a((_ctx, _cache, $props, $setup, $data, $options) => {
    const _component_card = vue.resolveComponent("card");
    const _component_version_card = vue.resolveComponent("version-card");

    return (vue.openBlock(), vue.createBlock("div", _hoisted_1$j, [
  ...
  var css_248z$i = ".index-container[data-v-957c9522] {\n  background-color: #f5f6f7;\n}\n";
  styleInject$1(css_248z$i);

  script$l.render = render$l;
  script$l.__scopeId = "data-v-957c9522";
  script$l.__file = "src/components/home.vue";
  ...
  const _withId$9 = /*#__PURE__*/vue.withScopeId("data-v-9d220f86");

  vue.pushScopeId("data-v-9d220f86");
  const _hoisted_1$i = { class: "tab-container" };
  const _hoisted_2$c = { class: "tab-list" };
  const _hoisted_3$c = { class: "tab-item-text" };
  vue.popScopeId();

  const render$k = /*#__PURE__*/_withId$9((_ctx, _cache, $props, $setup, $data, $options) => {
    return (vue.openBlock(), vue.createBlock("div", _hoisted_1$i, [
      vue.createVNode("div", _hoisted_2$c, [
        (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($props.tabs, (item, index) => {
          return (vue.openBlock(), vue.createBlock("div", {
            ...
            vue.createVNode("span", _hoisted_3$c, vue.toDisplayString(item.name), 1 /* TEXT */)
  ...
  const _withId$8 = /*#__PURE__*/vue.withScopeId("data-v-151438cc");

  const render$j = /*#__PURE__*/_withId$8((_ctx, _cache, $props, $setup, $data, $options) => {
  ...
  var css_248z$g = ".detail-container[data-v-151438cc] {\n  font-size: 12px;\n  margin-left: 24px;\n  position: relative;\n}\n.can-unfold[data-v-151438cc][data-v-151438cc]::before {\n  content: \"\";\n  width: 0;\n  height: 0;\n  border: 4px solid transparent;\n  position: absolute;\n  border-left-color: #333;\n  left: -12px;\n  top: 3px;\n}\n.unfolded[data-v-151438cc][data-v-151438cc]::before {\n  border: 4px solid transparent;\n  border-top-color: #333;\n  top: 6px;\n}\n";
  styleInject(css_248z$g);

  script$j.render = render$j;
  script$j.__scopeId = "data-v-151438cc";
  script$j.__file = "src/plugins/console/log-detail.vue";
  ...
  const _withId$7 = /*#__PURE__*/vue.withScopeId("data-v-722c5870");

  vue.pushScopeId("data-v-722c5870");
  const _hoisted_1$g = { class: "log-container" };
  vue.popScopeId();
  ...
  const render$h = /*#__PURE__*/_withId$7((_ctx, _cache, $props, $setup, $data, $options) => {
    ...
    return (vue.openBlock(), vue.createBlock("div", _hoisted_1$g, [
  ...
  const _withId$6 = /*#__PURE__*/vue.withScopeId("data-v-f469c502");

  vue.pushScopeId("data-v-f469c502");
  const _hoisted_1$f = { class: "operation" };
  const _hoisted_2$b = { class: "input-wrapper" };
  const _hoisted_3$b = /*#__PURE__*/vue.createVNode("span", null, "Excute", -1 /* HOISTED */);
  vue.popScopeId();
  ...
  const render$g = /*#__PURE__*/_withId$6((_ctx, _cache, $props, $setup, $data, $options) => {
    return (vue.openBlock(), vue.createBlock("div", _hoisted_1$f, [
      vue.createVNode("div", _hoisted_2$b, [
  ...
  var css_248z$d = ".operation[data-v-f469c502] {\n  height: 50px;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n}\n.input-wrapper[data-v-f469c502] {\n  flex: 1;\n  height: 100%;\n}\n.input-wrapper[data-v-f469c502] .input[data-v-f469c502] {\n  height: 100%;\n  width: 100%;\n  outline: none;\n  border: none;\n  line-height: 100%;\n  padding: 0 10px;\n  font-size: 18px;\n}\n.button-wrapper[data-v-f469c502] {\n  height: 100%;\n  line-height: 100%;\n  margin-left: 10px;\n  padding: 0 10px;\n  border-left: 1px solid #f5f6f7;\n  display: flex;\n  align-items: center;\n}\n";
  styleInject(css_248z$d);

  script$g.render = render$g;
  script$g.__scopeId = "data-v-f469c502";
  script$g.__file = "src/plugins/console/op-command.vue";

  var script$f = {
    components: {
      ConsoleTap: script$k,
      LogContainer: script$h,
      OperationCommand: script$g
    },
    data() {
      return {
        logTabs: LogTabs,
  ...
  const _withId$5 = /*#__PURE__*/vue.withScopeId("data-v-35ae264e");

  vue.pushScopeId("data-v-35ae264e");
  const _hoisted_1$e = { class: "console-container" };
  const _hoisted_2$a = { class: "log-container" };
  const _hoisted_3$a = { class: "info-container" };
  const _hoisted_4$4 = { class: "operation-container" };
  vue.popScopeId();
  ...
  var css_248z$c = ".console-container[data-v-35ae264e] {\n  display: flex;\n  flex-direction: column;\n  height: 100%;\n}\n.log-container[data-v-35ae264e] {\n  flex: 1;\n  display: flex;\n  flex-direction: column;\n  overflow: hidden;\n}\n.log-container[data-v-35ae264e] .info-container[data-v-35ae264e] {\n  flex: 1;\n  background-color: #ffffff;\n  border-bottom: 1px solid #f5f6f7;\n  overflow-y: scroll;\n}\n";
  styleInject(css_248z$c);

  script$f.render = render$f;
  script$f.__scopeId = "data-v-35ae264e";
  script$f.__file = "src/plugins/console/main.vue";
  ...
  const _hoisted_1$d = { class: "dokit-card" };
  const _hoisted_2$9 = { class: "dokit-card__header" };
  const _hoisted_3$9 = { class: "dokit-card__body" };

  function render$e(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("div", _hoisted_1$d, [
      vue.createVNode("div", _hoisted_2$9, vue.toDisplayString($props.title), 1 /* TEXT */),
  ...
  const _withId$4 = /*#__PURE__*/vue.withScopeId("data-v-756cbe6c");

  vue.pushScopeId("data-v-756cbe6c");
  const _hoisted_1$c = { class: "app-info-container" };
  const _hoisted_2$8 = { class: "info-wrapper" };
  const _hoisted_3$8 = /*#__PURE__*/vue.createVNode("td", { class: "key" }, "UA", -1 /* HOISTED */);
  const _hoisted_4$3 = { class: "value" };
  const _hoisted_5$3 = /*#__PURE__*/vue.createVNode("td", { class: "key" }, "URL", -1 /* HOISTED */);
          ...
          default: _withId$4(() => [
            vue.createVNode("table", null, [
              vue.createVNode("tr", null, [
                _hoisted_3$8,
                vue.createVNode("td", _hoisted_4$3, vue.toDisplayString($data.ua), 1 /* TEXT */)
              ]),
              vue.createVNode("tr", null, [
                _hoisted_5$3,
                vue.createVNode("td", _hoisted_6$2, vue.toDisplayString($data.url), 1 /* TEXT */)
              ])
            ])
          ]),
          _: 1 /* STABLE */
  ...
  var css_248z$a = ".app-info-container[data-v-756cbe6c] {\n  font-size: 14px;\n  height: 100%;\n  overflow: hidden;\n}\n.info-wrapper[data-v-756cbe6c] {\n  margin: 5px 5px 0 5px;\n}\n.info-wrapper[data-v-756cbe6c] .key[data-v-756cbe6c] {\n  font-weight: bold;\n}\ntable[data-v-756cbe6c] {\n  border-color: #eee;\n  width: 100%;\n  border-collapse: collapse;\n  border-spacing: 0;\n}\ntr[data-v-756cbe6c] {\n  width: 100%;\n}\ntd[data-v-756cbe6c],\nth[data-v-756cbe6c] {\n  padding: 5px;\n}\n";
  styleInject(css_248z$a);

  script$d.render = render$d;
  script$d.__scopeId = "data-v-756cbe6c";
  script$d.__file = "src/plugins/app-info/ToolAppInfo.vue";
  ...
  const _hoisted_1$b = { class: "info-card" };
  const _hoisted_2$7 = { class: "info-card-header" };
  const _hoisted_3$7 = { class: "info-card-header__title" };
  const _hoisted_4$2 = { class: "info-card-header__opt" };
  const _hoisted_5$2 = { class: "filter-text" };
  const _hoisted_6$1 = { class: "info-card-body" };
  const _hoisted_7$1 = { class: "info-key" };
  ...
  function render$c(_ctx, _cache, $props, $setup, $data, $options) {
    return (vue.openBlock(), vue.createBlock("div", _hoisted_1$b, [
      vue.createVNode("div", _hoisted_2$7, [
        vue.createVNode("div", _hoisted_3$7, vue.toDisplayString($props.title), 1 /* TEXT */),
        vue.createVNode("div", _hoisted_4$2, [
          vue.createVNode("div", {
            class: ["filter-box", $data.keyword ? 'filter-box-actived' : '']
          }, [
            vue.createVNode("span", _hoisted_5$2, vue.toDisplayString($data.keyword), 1 /* TEXT */),
          ...
          vue.createVNode("tbody", null, [
            (vue.openBlock(true), vue.createBlock(vue.Fragment, null, vue.renderList($options.filteredMap, (value, key) => {
              return (vue.openBlock(), vue.createBlock("tr", {
                ...
                vue.createVNode("td", _hoisted_7$1, vue.toDisplayString(key), 1 /* TEXT */),
  ...
  script$b.__file = "src/plugins/storage/local-storage.vue";
  ...
  const _hoisted_1$a = { style: {"margin-top":"20px"} };
  ...
  script$a.__file = "src/plugins/storage/session-storage.vue";
  ...
  const _hoisted_1$9 = { style: {"margin-top":"20px"} };
  ...
  script$9.__file = "src/plugins/storage/cookie.vue";

  var script$8 = {
    components: {
      localStorage: script$b,
      sessionStorage: script$a,
      cookie: script$9
    }
  };

  const _hoisted_1$8 = { class: "storage-plugin" };
  ...
  script$8.__file = "src/plugins/storage/main.vue";
  ...
  */
  ...
  const _withId$3 = /*#__PURE__*/vue.withScopeId("data-v-0274cd90");

  vue.pushScopeId("data-v-0274cd90");
  const _hoisted_1$6 = { class: "hello-independ" };
  ...
  const _hoisted_3$5 = /*#__PURE__*/vue.createVNode("div", null, "Demo Independ Plugin", -1 /* HOISTED */);
  vue.popScopeId();

  const render$6 = /*#__PURE__*/_withId$3((_ctx, _cache, $props, $setup, $data, $options) => {
    const _directive_dragable = vue.resolveDirective("dragable");

    return vue.withDirectives((vue.openBlock(), vue.createBlock("div", _hoisted_1$6, [
      _hoisted_2$5,
      _hoisted_3$5,
      vue.createVNode("div", {
  ...
  script$6.__scopeId = "data-v-0274cd90";
  script$6.__file = "src/plugins/demo-single-plugin/IndependPluginDemo.vue";
