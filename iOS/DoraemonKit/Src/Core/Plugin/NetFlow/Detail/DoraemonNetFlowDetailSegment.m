...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        _selectLine = [[UIView alloc] initWithFrame:CGRectMake(self.doraemon_width/4-kDoraemonSizeFrom750(128)/2, self.doraemon_height-kDoraemonSizeFrom750(4), kDoraemonSizeFrom750(128), kDoraemonSizeFrom750(4))];
...
- (void)leftTap{
    ...
    _leftLabel.textColor = [UIColor doraemon_colorWithHexString:@"337CC4"];
    _rightLabel.textColor = [UIColor doraemon_colorWithHexString:@"333333"];
    _selectLine.frame = CGRectMake(self.doraemon_width/4-kDoraemonSizeFrom750(128)/2, self.doraemon_height-kDoraemonSizeFrom750(4), kDoraemonSizeFrom750(128), kDoraemonSizeFrom750(4));
}
...
- (void)rightTap{
    ...
    _selectLine.frame = CGRectMake(self.doraemon_width*3/4-kDoraemonSizeFrom750(128)/2, self.doraemon_height-kDoraemonSizeFrom750(4), kDoraemonSizeFrom750(128), kDoraemonSizeFrom750(4));
}
